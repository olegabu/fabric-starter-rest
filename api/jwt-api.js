...
module.exports = function (app, server, defaultFabricStarterClient) {
    ...
    app.post('/users', asyncMiddleware(async (req, res, next) => {
        ...
        mapFabricStarterClient[req.body.username] = new FabricStarterClient(null, defaultFabricStarterClient.txEventQueue); //todo: client should be created in fabricStarterRuntime
